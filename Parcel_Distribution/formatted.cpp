...
//
//	do {
//		cout << "Enter Your Phone Number (e.g., 03XXXXXXXXX): ";
//		getline(cin, newOrder.phoneNumber);
//
//		// Validate: 11 digits, starts with 03, all digits
//		if (newOrder.phoneNumber.length() == 11 &&
//			newOrder.phoneNumber.substr(0, 2) == "03" &&
//			all_of(newOrder.phoneNumber.begin(), newOrder.phoneNumber.end(), ::isdigit)) {
//			break;
//		}
//		else {
...
//	int weight;
//	do {
//		cout << "Enter Parcel Weight (1 - 10 kg): ";
//		string input;
//		getline(cin, input);
//
...
//			}
//		}
//		cout << "Parcels above 10 kg are not allowed due to delivery constraints.\n";
//	} while (true);
//
//	newOrder.parcelWeight = weight;
//
